<div id="think_page_trace"
	...
	<div id="think_page_trace_tab"
		...
		<div id="think_page_trace_tab_tit"
			...
			<span
				style="color: #000; padding-right: 12px; height: 30px; line-height: 30px; display: inline-block; margin-right: 3px; cursor: pointer; font-weight: 700">
				<?php echo $key ?>
			</span>
			<?php } ?>
		</div>
...
<div id="think_page_trace_open"
	...
	<div
		style="background: #232323; color: #FFF; padding: 0 6px; float: right; line-height: 30px; font-size: 14px">
		<?php echo G('beginTime','viewEndTime').'s ';?>
	</div>
	<img width="30" style="" title="ShowPageTrace"
		src="data:image/png;base64,<?php echo \Think\App::logo() ?>">
</div>
